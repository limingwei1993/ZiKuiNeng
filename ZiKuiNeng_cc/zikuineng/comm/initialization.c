...
void GIOP_Int(void)
{
        ...
        GpioCtrlRegs.GPCMUX1.bit.GPIO76 = 0; // Configure GPIO76 as GPIO to CS
        GpioCtrlRegs.GPCMUX1.bit.GPIO77 = 0; // Configure GPIO77 as GPIO to CLK
        GpioCtrlRegs.GPCMUX1.bit.GPIO78 = 0; // Configure GPIO78 as GPIO to MOSI

        GpioCtrlRegs.GPCDIR.bit.GPIO76 = 1; // GPIO1 = output
        GpioCtrlRegs.GPCDIR.bit.GPIO77 = 1; // GPIO2 = output
        GpioCtrlRegs.GPCDIR.bit.GPIO78 = 1; // GPIO3 = output
        EDIS;
