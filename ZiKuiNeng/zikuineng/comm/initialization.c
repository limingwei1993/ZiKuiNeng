...
void GIOP_Int(void)
{
        ...
        GpioCtrlRegs.GPCPUD.bit.GPIO76 = 0;   //Enable pull-up on GPIO1 (Dial code)
        GpioCtrlRegs.GPCPUD.bit.GPIO77 = 0;   //Enable pull-up on GPIO2 (Dial code)
        GpioCtrlRegs.GPCPUD.bit.GPIO78 = 0;   //Enable pull-up on GPIO3 (Dial code)
        GpioCtrlRegs.GPCPUD.bit.GPIO79 = 0;   //Enable pull-up on GPIO4 (Dial code)

        GpioCtrlRegs.GPCMUX1.bit.GPIO76 = 0; // Configure GPIO1 as GPIO1
        GpioCtrlRegs.GPCMUX1.bit.GPIO77 = 0; // Configure GPIO1 as GPIO1
        GpioCtrlRegs.GPCMUX1.bit.GPIO78 = 0; // Configure GPIO1 as GPIO1
        GpioCtrlRegs.GPCMUX1.bit.GPIO79 = 0; // Configure GPIO1 as GPIO1

        GpioCtrlRegs.GPCDIR.bit.GPIO76 = 0; // GPIO1 = input
        GpioCtrlRegs.GPCDIR.bit.GPIO77 = 0; // GPIO2 = input
        GpioCtrlRegs.GPCDIR.bit.GPIO78 = 0; // GPIO3 = input
        GpioCtrlRegs.GPCDIR.bit.GPIO79 = 0; // GPIO4 = input
