...
void ADS1258_ReadDate(void)
{
   ...
   SPI_END();
    ...
    adc_value = (uint32_t)(RXData[1] * 65536 + RXData[2] * 256 + RXData[3]);
    CH = (uint8_t)(RXData[0] & 0x1F);
    switch(CH)
    {
           case 8:
                 if((adc_value > 0x000000) && (adc_value <= 0x780000))
                 {
                    Temp = (float)((adc_value * Reference_Voltage)/ 7864320);
                 }
              //   ADC_CURRENT_mA.signal_1_temperature = (float)((Temp*1000000-168000)/563);
                 ADC_CURRENT_mA.signal_1_temperature =Temp/Reference_Voltage*350 ;
                 ADC_CURRENT_mA.collection_valid |=0x0001;
                 break;
           case 9:
                 if((adc_value > 0x000000) && (adc_value <= 0x780000))
                 {
              ...
              //   ADC_CURRENT_mA.signal_1_pressure  = Temp;
                 ADC_CURRENT_mA.signal_1_pressure  = Temp/Reference_Voltage*350;
                 ADC_CURRENT_mA.collection_valid |=0x0002;
             break;
           case 10:
                if((adc_value > 0x000000) && (adc_value <= 0x780000))
                {
               ...
               // ADC_CURRENT_mA.signal_2_temperature = (float)((Temp*1000000-168000)/563+25);
                  ADC_CURRENT_mA.signal_2_temperature =Temp/Reference_Voltage*350 ;
                ADC_CURRENT_mA.collection_valid |=0x0004;
                break;
          case 11:
                if((adc_value > 0x000000) && (adc_value <= 0x780000))
                {
             ...
             //   ADC_CURRENT_mA.signal_2_pressure  = Temp;
                ADC_CURRENT_mA.signal_2_pressure  = Temp/Reference_Voltage*350 ;
                ADC_CURRENT_mA.collection_valid |=0x0008;
          ...
          case 12:
              ...
              // ADC_CURRENT_mA.signal_3_temperature = (float)((Temp*1000000-168000)/563+25);
               ADC_CURRENT_mA.signal_3_temperature =Temp/Reference_Voltage*350 ;
               ADC_CURRENT_mA.collection_valid |=0x0010;
               break;
         case 13:
               if((adc_value > 0x000000) && (adc_value <= 0x780000))
               {
             ...
             //  ADC_CURRENT_mA.signal_3_pressure  = Temp;
               ADC_CURRENT_mA.signal_3_pressure  = Temp/Reference_Voltage*350;
               ADC_CURRENT_mA.collection_valid |=0x0020;
         ...
         case 14:
            ...
            //  ADC_CURRENT_mA.signa2_1_temperature = (float)((Temp*1000000-168000)/563+25);
                ADC_CURRENT_mA.signa2_1_temperature =Temp/Reference_Voltage*350 ;
              ADC_CURRENT_mA.collection_valid |=0x0040;
        ...
        case 15:
           ...
           //   ADC_CURRENT_mA.signa2_1_pressure  = Temp;
              ADC_CURRENT_mA.signa2_1_pressure  = Temp/Reference_Voltage*350;
              ADC_CURRENT_mA.collection_valid |=0x0080;
       ...
       case 16:
           ...
           //  ADC_CURRENT_mA.signa2_2_temperature = (float)((Temp*1000000-168000)/563+25);
             ADC_CURRENT_mA.signa2_2_temperature =Temp/Reference_Voltage*350 ;
             ADC_CURRENT_mA.collection_valid |=0x0100;
       ...
       case 17:
          ...
          //  ADC_CURRENT_mA.signa2_2_pressure  = Temp;
            ADC_CURRENT_mA.signa2_2_pressure  = Temp/Reference_Voltage*350;
            ADC_CURRENT_mA.collection_valid |=0x0200;
       ...
       //     ADC_CURRENT_mA.signa2_3_temperature = (float)((Temp*1000000-168000)/563+25);
            ADC_CURRENT_mA.signa2_3_temperature =Temp/Reference_Voltage*350 ;
            ADC_CURRENT_mA.collection_valid |=0x0400;
      ...
      case 19:
          ...
          //  ADC_CURRENT_mA.signa2_3_pressure  = Temp;
            ADC_CURRENT_mA.signa2_3_pressure  = Temp/Reference_Voltage*350 ;;
            ADC_CURRENT_mA.collection_valid |=0x0800;
